<footer class="bg-[#2b2a24] py-0">
  <div class="mx-auto max-w-7xl px-6 pt-8 pb-8 sm:pt-12 lg:px-8 lg:pt-16">
    <div class="flex flex-col items-center space-y-6 text-center">
      ...
      <p class="text-sm text-[#845d45] max-w-md">
        Boutique Reformer Pilates studio in Bethnal Green. Find your flow.
      </p>
      <div class="flex space-x-6">
        <a href="https://instagram.com" target="_blank" class="text-[#845d45] hover:text-[#fed783]" aria-label="Instagram">
        ...
        <a href="https://tiktok.com" target="_blank" class="text-[#845d45] hover:text-[#fed783]" aria-label="TikTok">
    ...
    <div class="mt-12 border-t border-white/10 pt-6 text-center">
      <p class="text-sm text-[#845d45]">&copy; <?= date('Y') ?> FlowHaven Studios. All rights reserved.</p>
    </div>
  </div>
</footer>
