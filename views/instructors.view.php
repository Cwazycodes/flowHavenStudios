...
<div class="bg-[#f2e9dc] min-h-screen">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
    ...
    <!-- Header Section -->
    <div class="mx-auto max-w-4xl text-center mb-16 sm:mb-20 lg:mb-24">
      <h1 class="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#2b2a24] font-quicksand mb-6">
        meet our instructors
      </h1>
      <p class="text-base sm:text-lg lg:text-xl text-[#845d45] font-quicksand leading-relaxed max-w-3xl mx-auto">
        our passionate team of certified pilates instructors brings years of expertise, diverse backgrounds, and a shared commitment to helping you find your flow. each brings their unique style and energy to create transformative experiences on the reformer.
      </p>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden h-full flex flex-col">
          ...
          <div class="aspect-[4/5] overflow-hidden">
            <img src="assets/instructor-images/sydra-robert-ana.jpg" 
                 alt="Sydra Robert Ana - Mat & Reformer Pilates Instructor"
                 class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                 loading="lazy" />
          </div>
    ...
    <div class="mt-20 sm:mt-24 lg:mt-32">
      <div class="mx-auto max-w-4xl text-center">
        <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#2b2a24] font-quicksand mb-8 sm:mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div class="text-center">
            <div class="w-16 h-16 mx-auto mb-4 bg-[#845d45]/10 rounded-full flex items-center justify-center">
              <svg class="w-8 h-8 text-[#845d45]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
              </svg>
            </div>
            <h3 class="text-lg font-semibold text-[#845d45] font-quicksand mb-3">
              personalized attention
            </h3>
            <p class="text-sm sm:text-base text-gray-600 font-quicksand leading-relaxed">
              every body is unique. our instructors provide individual modifications and hands-on guidance to ensure you're moving safely and effectively.
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-sm sm:text-base text-gray-600 font-quicksand leading-relaxed">
              we believe in quality over quantity. each movement is purposeful, connecting breath, mind, and body for transformative results.
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-sm sm:text-base text-gray-600 font-quicksand leading-relaxed">
              welcome to all. our studio is a safe space where everyone can explore their potential, regardless of experience or fitness level.
            </p>
          </div>
     ...
     <div class="mt-20 sm:mt-24 lg:mt-32">
      <div class="relative isolate overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
        ...
        <div class="absolute inset-0 -z-10">
          <img src="/assets/images/studio-atmosphere.jpg" 
               alt="Flow Haven Studio" 
               class="h-full w-full object-cover object-center" 
               loading="lazy" />
          <div class="absolute inset-0 bg-[#845d45]/40"></div>
        </div>
        ...
        <div class="px-6 py-16 sm:px-16 sm:py-24 lg:py-32 text-center">
          ...
          <p class="mx-auto max-w-2xl text-base sm:text-lg lg:text-xl text-white/90 font-quicksand mb-8 sm:mb-10">
            book a class and experience the expertise, passion, and personalized attention our instructors bring to every session
          </p>

          <div class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <a href="/book" 
               class="w-full sm:w-auto inline-block rounded-full border-2 border-white px-6 sm:px-8 py-3 sm:py-4 text-white font-quicksand hover:bg-white hover:text-[#845d45] transition-all duration-300 font-medium text-base sm:text-lg active:scale-95">
              book your class
            </a>
            <a href="/faq" 
               class="w-full sm:w-auto inline-block rounded-full border-2 border-white px-6 sm:px-8 py-3 sm:py-4 text-white font-quicksand hover:bg-white hover:text-[#845d45] transition-all duration-300 font-medium text-base sm:text-lg active:scale-95">
...
<!-- Enhanced styles for instructor page -->
<style>
