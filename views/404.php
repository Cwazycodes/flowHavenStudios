...
<main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
  <div class="text-center">
    <p class="text-base font-semibold text-[#845d45]">404</p>
    ...
    <div class="mt-10 flex items-center justify-center gap-x-6">
      <a href="/" class="btn-brand rounded-md px-3.5 py-2.5 text-sm font-semibold shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#fed783]">Go back home</a>
    </div>
  </div>
</main>
